...
mkdir -p .tmp/s4p_closure
cp artifacts/stitch_constants.json .tmp/s4p_closure/stitch_constants.json
cp artifacts/constants_registry.json .tmp/s4p_closure/constants_registry.json
