...
mkdir -p .repro_tmp/s4p_closure
cp artifacts/stitch_constants.json .repro_tmp/s4p_closure/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/s4p_closure/constants_registry.json
