...
Canonical Lane research workspace for a flagship problem in geometric topology:
proving that every smooth closed 4-manifold homeomorphic to `S^4` is diffeomorphic to `S^4` through an admissible smooth-structure closure architecture.

## Main Manuscript

- [paper/SMOOTH_4D_POINCARE_CONJECTURE_PREPRINT.md](paper/SMOOTH_4D_POINCARE_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `SMOOTH_4D_POINCARE_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/SMOOTH_4D_POINCARE_CONJECTURE_PREPRINT.md`.
...
Current S4P runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/s4p_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/s4p_closure_guard.py`.
...
- Manuscript target: [paper/SMOOTH_4D_POINCARE_CONJECTURE_PREPRINT.md](paper/SMOOTH_4D_POINCARE_CONJECTURE_PREPRINT.md)
